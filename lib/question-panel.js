...
var QuestionPanel = module.exports = React.createClass({
	...
	setVia: function (event) {
		this.props.updateQuestion(_.merge( this.props.question && this.props.question.media, { via: event.target.value }));
	},
		...
		return (
			<div className="questionPanel">
				...
				<div className="clearfix">
					...
					<MediaInput imageSrc={ this.props.question && this.props.question.media && this.props.question.media.image } onChange={ this.setImage }/>
				</div>
				<label>
