		...
		var Questions = this.props.questions.map(function (question, index){
			...
			return (
				<TabView
					...
					tabPanels={ [<QuestionPanel removeQuestion={ this.props.removeQuestion } question={ question } updateQuestion={ updateThisQuestion } />, <AnswerPanel resultTitles={ this.props.resultTitles } answers={ question.answers } title={ question.prompt } />]}
