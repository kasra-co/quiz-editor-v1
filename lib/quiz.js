	...
	render: function() {
		...
		return (
			<div id="quizComponent">
				<QuizResults addResult={this.addResult} removeResult={this.removeResult} updateResult={ this.updateResult } results={ this.state.results } />
				<QuizQuestions addQuestion={ this.addQuestion } removeQuestion={this.removeQuestion} questions={ this.state.questions } updateAnswer={ this.updateAnswer } updateQuestion={ this.updateQuestion } resultTitles={ resultTitles } />
			</div>
		);
	}
});
