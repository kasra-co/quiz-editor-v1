	...
	render: function() {
		...
		return (
			<div id="quizComponent">
				...
				<QuizQuestions addQuestion={ this.addQuestion } removeQuestion={this.removeQuestion} questions={ this.state.questions } updateQuestion={ this.updateQuestion } resultTitles={ resultTitles } />
			</div>
		);
	}
});
